START_DIR = C:\doiUsers\Max\GGBSFO~1\FORJMD~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2013a
MAKEFILE = myMetropolisHasting_mex.mk

include myMetropolisHasting_mex.mki
...
SRC_FILES =  \
	...
	myMetropolisHasting_emxutil.c \
	myMetropolisHasting_mex.c

MEX_FILE_NAME_WO_EXT = myMetropolisHasting_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\myMetropolisHasting"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\myMetropolisHasting/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\myMetropolisHasting/%.cpp
	$(CC) $(CPPFLAGS) "$<"
