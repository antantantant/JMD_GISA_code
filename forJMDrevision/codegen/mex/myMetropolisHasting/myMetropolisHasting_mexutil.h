...
#ifndef __MYMETROPOLISHASTING_MEXUTIL_H__
#define __MYMETROPOLISHASTING_MEXUTIL_H__
/* Include files */
#include <math.h>
#include <stdlib.h>
#include <string.h>
...
#endif
/* End of code generation (myMetropolisHasting_mexutil.h) */
