function [probability_obj_set,pairs,partworths] = ...
    appGGBS_PLUS(s,d,Xf,dX,dXID,c,inq,alg,queryID,W0,w,target,C,...
    ...
    while  nq>=0
        % calculate A
        [A,W,I,unique_I,w0] = appObjDistribution(s,d,W0,Xf,dX,dXID,c,alg,pairs,C);
...
%                 w_rand = mvnrnd(w, true_var*eye(length(w)),1);
